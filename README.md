...
- creating an account.
- changing profile pic and information .
- search for any recipe and proccessed to the details.
- user can add/remove recipe to his favorite list. 
- any information or changes are saved to firebase.
